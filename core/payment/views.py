...
from .models import PaymentModel, PaymentStatusModel
...
class PaymentVerifyView(View):
    def get(self, request, *args, **kwargs):
        ...
        if data["code"] == 100 or data["code"] == 101:
            ...
            payment_obj.status= PaymentStatusModel.success.value
            payment_obj.save()
            ...
            payment_obj.status= PaymentStatusModel.failed.value
            payment_obj.save()
